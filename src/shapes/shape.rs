...
pub trait Shape: Any + fmt::Debug {
    ...
    ///
    /// let s = Sphere::new();
    /// let n = s.normal_at(Point::new(1.0, 0.0, 0.0), None, None);
    ///
...
mod tests {
    ...
    fn computing_normal_on_translated_shape() {
        ...
        let n = s.normal_at(Point::new(0.0, 1.7071, -0.70711), None, None);
    ...
    fn finding_the_normal_on_a_child_object() {
        ...
        let p = s.normal_at(Point::new(1.7321, 1.1547, -5.5774), None, Some(&w));
